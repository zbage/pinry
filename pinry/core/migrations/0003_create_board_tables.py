...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_board', (
            ...
            ('settings', self.gf('pinry.core.models.JSONField')(default={})),
        ))
        db.send_create_signal(u'core', ['Board'])

        # Adding M2M table for field members on 'Board'
        db.create_table(u'core_board_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('board', models.ForeignKey(orm[u'core.board'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'core_board_members', ['board_id', 'user_id'])

        # Adding field 'Pin.board'
        db.add_column(u'core_pin', 'board',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='pins', null=True, to=orm['core.Board']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field members on 'Board'
        db.delete_table('core_board_members')

        # Deleting field 'Pin.board'
        db.delete_column(u'core_pin', 'board_id')
